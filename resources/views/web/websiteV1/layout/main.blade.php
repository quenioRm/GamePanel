...
<html lang="en">
   <head>
      ...
      <link rel="shortcut icon" href="{{asset('assets/web/images/main/icon.png')}}" type="image/x-icon">
   ...
   <body class="type_aal">
      ...
      <div class="container-doc">
         @include('web.' . env('SELECTED_WEB') . '.layout.header')
         <main id="mainContent" class="doc-main">
            {{-- Content --}}
            @yield('content')
         </main>
         @include('web.' . env('SELECTED_WEB') . '.layout.footer')
